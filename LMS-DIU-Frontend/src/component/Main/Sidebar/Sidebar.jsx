...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <div>
      {/* Desktop Sidebar */}
      <div className="hidden md:block w-full md:w-[200px] lg:w-[250px] xl:w-[280px] h-full bg-[#038c6d] fixed shadow-2xl border-r-2 border-[#f13919]">
        <Link to={"/"} className="flex flex-col border-b-2 border-[#f13919] justify-center items-center pt-5 gap-2 mb-10 text-black">
          <img src={logo} alt="logo" className="w-[70px] mb-5 " />
        </Link>
